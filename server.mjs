...
client.on('interactionCreate', async interaction => {
    ...
    if (commandName === 'crear-encuesta') {
        ...
        try {
            ...
            console.log('Encuesta agregada a la API externa:', response.data);
            ...
            for (let [index, opcion] of opciones.entries()) {
                ...
                console.log('Opción agregada a la API externa:', opcionResponse.data);
        ...
        collector.on('collect', async i => {
            ...
            try {
                ...
                console.log(`Votos actuales para la encuesta ${encuestaMessage.id}:`, Array.from(pollData.voteDetails.entries()));
        ...
        collector.on('end', () => {
            ...
            console.log(`Votos finales para la encuesta ${encuestaMessage.id}:`, Array.from(pollData.voteDetails.entries()));
